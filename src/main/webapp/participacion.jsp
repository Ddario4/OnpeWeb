...
<html>
 ...
 <tr onclick="location.href='svlParticipacion?id=<%= (id + "," + aData[0]) %>'" onmouseover="this.style.cursor = &quot;pointer&quot;; this.style.color = &quot;grey&quot;" onmouseout="this.style.color = &quot;black&quot;" style="cursor: pointer; color: black;">                                        <td><%=aData[0] %></td>
                                        <td><%=aData[1] %></td>
                                        <td><%=aData[2] %></td>
                                        <td><%=aData[3] %></td>
                                        <td><%=aData[4] %></td>
